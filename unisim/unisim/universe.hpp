...
namespace Diana
{
    ...
    class Universe
    {
        ...
        friend void PhysicsObject_init(struct PhysicsObject* obj, Universe* universe, struct Vector3* position, struct Vector3T<double>* velocity, struct Vector3T<double>* ang_velocity, struct Vector3T<double>* thrust, double mass, double radius, char* obj_desc, struct Spectrum* spectrum);
